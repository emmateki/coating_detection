...
var pmCmds = newMenu("Popup Menu",
	...
	"Find Commands...", "Control Panel...", "Startup Macros...", "Search...","Set default ROI ...", "Set Scale to 20 um ...", "Save measurments...", "Predict coating...", "Model..."));
...
macro "Popup Menu" {
	...
	if (cmd=="Help...")
		...
		scriptpath= dir_scripts  + "UJV_EM" + File.separator + "UJV.py";
		...
		setScale(0.07881773, 0.07881773, "um"); // Set scale to 20 micrometers per 253.75 pixels
		 ...
		 num_of_roi_lines = 10;
   		 python_path = "python";
   		 dir_scripts = getDirectory("macros");
   		 script_path = dir_scripts  + "UJV_EM" + File.separator + "api.py"; // Use File.separator for platform-independent file separators
  		 imageTitle = getTitle();
    	 imageDir = getDirectory("image");
		 ...
		 num_of_roi_lines = 10;
   		 python_path = "python";
   		 dir_scripts = getDirectory("macros");
   		 script_path = dir_scripts  + "UJV_EM" + File.separator + "api_model.py"; // Use File.separator for platform-independent file separators
  		 imageTitle = getTitle();
    	 imageDir = getDirectory("image");
 		 ...
 		 command = python_path + " " + script_path + " " + input_image_path + " " + num_of_roi_lines; 
   		...
   		if (File.exists(roi_path_without_whitespace)) {
            ...
            showMessage("Error: ROI file not found. Make sure you performed the 'Model...' operation correctly.Predict is used for images only.");
        }
...
// Set scale for the current image
function setScale(pixelWidth, pixelHeight, unit) {
